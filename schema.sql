...
INSERT INTO settings (key, value) VALUES
    ...
    ('messengers', '[]'),
    ('bounce.enabled', 'true'),
    ('bounce.enable_webhooks', 'true'),
    ('bounce.count', '2'),
    ('bounce.action', '"blocklist"'),
    ('bounce.mailboxes',
        '[{"enabled":false, "type": "pop", "host":"pop.yoursite.com","port":995,"auth_protocol":"userpass","username":"username","password":"password","scan_interval":"15m","tls_enabled":true,"tls_skip_verify":false}]');
